 ...
 */  
		 generatedBlocks: {
            robot: {
               easy: ["east", "west", "pickTransportable", "dropTransportable"],
               medium: ["east", "west", "north", "south", "pickTransportable", "dropTransportable"],
               hard: ["east", "west", "north", "south", "pickTransportable", "dropTransportable"]
            }
         },		 
         standardBlocks: {
            includeAll: false,
